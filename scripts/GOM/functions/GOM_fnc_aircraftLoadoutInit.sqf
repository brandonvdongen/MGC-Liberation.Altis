...
{_x setAmmoCargo 0;_x setFuelCargo 0;_x setRepairCargo 0} foreach _nearbyVehs;
...
//muhaha
([0,0,0] nearObjects 150000) select {typeOf _x isKindOf "Static" AND getFuelCargo _x > 0} apply {_x setFuelCargo 0};
