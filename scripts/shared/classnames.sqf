...
//This part tells the server which unit plays the following roles. Enemy squads are created from these values also. I don't see why you'd want to change this without it being modded content.
...
//Viper squads. These appear after 75% and this is where they're declared.
