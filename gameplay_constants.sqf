GRLIB_save_key = "tAnoa";	// change this value if you want different savegames on different map
...
GRLIB_sector_size = 850;
GRLIB_capture_size = 165;
GRLIB_radiotower_size = 2000;
GRLIB_recycling_percentage = 0.99;
GRLIB_endgame = 0;
...
GRLIB_secondary_missions_costs = [ 1, 1, 1 ];
GRLIB_halo_altitude = 1000;
GRLIB_civ_killing_penalty = 5;
